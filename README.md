...
jobs:
  claude-response:
    ...
    steps:
      - uses: aotoyuto/claude-code-action@beta  # Fork with OAuth support
        with:
...
This action is built on top of [`aotoyuto/claude-code-base-action`](https://github.com/aotoyuto/claude-code-base-action).
